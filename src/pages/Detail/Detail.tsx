...
import { getTaskById, handleDeleteClick } from "./Detail.handler";
import {
  editFormReducer,
      ...
      <div className="flex flex-row gap-3 pt-10 w-7/12">
        <div className="flex flex-col w-8/12">
          <div className="flex flex-row">
            ...
            <p className="text-xs font-normal ml-1 mt-1 text-custom-greyPrimary">
              {TASK_NUMBER_NAME}-{task.taskNumber}
            </p>
          </div>
          <InputTitle
            state={state}
        ...
        <div className="flex flex-col">
          ...
          <div className="mt-9 border-2 border-custom-greySecondary py-2 rounded-md pr-2">
            ...
            <div className="ml-2 mt-10 justify-center flex">
              <Button
                label="Delete"
                width="w-36"
                color="bg-custom-redPrimary"
                onClick={() => handleDeleteClick(task.id, navigate)}
              />
            </div>
          </div>
        </div>
